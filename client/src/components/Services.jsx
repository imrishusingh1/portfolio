...
const services = [
  {
    ...
    desc: 'Streamline your campaigns with tools that improve engagement, boost visibility, and help you reach your marketing goals.',
    bg: 'var(--lavender-bg)',
    icon: (
  ...
  {
    title: 'User Research',
    desc: 'Simplify project workflows with organized tools and strategies designed to keep your team aligned and productive.',
    bg: 'var(--green-pastel)',
    icon: (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <circle cx="24" cy="18" r="10"/>
        <circle cx="24" cy="18" r="5"/>
        <path d="M14 40 Q24 30 34 40"/>
  ...
  {
    title: 'Web Design',
    desc: 'Gain valuable insights into user behavior, website performance, and key business metrics to optimize your digital presence.',
    bg: 'var(--pink-pastel)',
    icon: (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <rect x="4" y="10" width="40" height="28" rx="3"/>
        <path d="M16 38 l-4 6 M32 38 l4 6 M12 44 h24"/>
        <path d="M4 16 h40"/>
  ...
  {
    title: 'Brand Design',
    desc: 'Understand your market with precise data analysis and deep customer insights that guide your decision-making processes.',
    bg: 'var(--blue-pastel)',
    icon: (
      <svg width="48" height="48" viewBox="0 0 48 48" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <line x1="24" y1="15" x2="10" y2="31"/>
        <line x1="24" y1="15" x2="38" y2="31"/>
    ...
    <section className="section services-section" id="services" ref={ref}>
      ...
      <div className="container">
        ...
        <div className="services-grid">
          {services.map(({ title, desc, bg, icon }, i) => (
            <motion.div
              key={title}
